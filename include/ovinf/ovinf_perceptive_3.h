#ifndef OVINF_PERCEPTIVE3_H
#define OVINF_PERCEPTIVE3_H
...
class PerceptivePolicy3 : public BasePolicy<float> {
 ...
 public:
  PerceptivePolicy3() = delete;
  ~PerceptivePolicy3();

  PerceptivePolicy3(const YAML::Node &config);
